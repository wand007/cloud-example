...
/**
 * @author ; lidongdong
 * @Description java8基于LocalDateTime的日期时间工具类
 * @Date 2019-11-01
 */
public final class LocalDateTimeUtils {
    ...
    /**
     * 获取本月最后一天的23:59:59 的秒数
     *
     * @return
     */
    public static Long getLastDayOfMonthSecond() {
        return LocalDateTime.now().with(TemporalAdjusters.lastDayOfMonth()).with(LocalTime.MAX).toEpochSecond(ZoneOffset.of(ZONE_OFFSET));
    }

    /**
     * 获取本月最后一天的23:59:59 的毫秒数
     *
     * @return
     */
    public static Long getLastDayOfMonthMilliSecond() {
        return LocalDateTime.now().with(TemporalAdjusters.lastDayOfMonth()).with(LocalTime.MAX).toInstant(ZoneOffset.of(ZONE_OFFSET)).toEpochMilli();
    }

    /**
     * 获取到本月最后一天的23:59:59 的剩余秒数
     *
     * @return
     */
    public static Long getLastDayOfMonthLaveSecond() {
        return getLastDayOfMonthSecond() - LocalDateTime.now().toEpochSecond(ZoneOffset.of("+8"));
    }

    /**
     * 获取到本月最后一天的23:59:59 的剩余毫秒数
     *
     * @return
     */
    public static Long getLastDayOfMonthLaveMilliSecond() {
        return getLastDayOfMonthMilliSecond() - LocalDateTime.now().toInstant(ZoneOffset.of(ZONE_OFFSET)).toEpochMilli();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getLastDayOfMonthSecond());
        System.out.println(getLastDayOfMonthMilliSecond());
        System.out.println(getLastDayOfMonthLaveMilliSecond());
        System.out.println(getLastDayOfMonthLaveSecond());
    }
